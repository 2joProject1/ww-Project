	...
	<div id="header-layout">
	    ...
	    <div id="container">
	        <div id="sidebar-layout">
	        	...
	        	<br>
	        		<b>전자결재</b>
	        		<div class="sub-menu"><a href="signoffs.docu">문서작성하기</a></div>
	        		<div class="sub-menu"><a href="">기안문서함</a></div>
	        		<div class="sub-menu"><a href="">수신문서함</a></div>
	        		<div class="sub-menu"><a href="">부서문서함</a></div>
	        		<div class="sub-menu"><a href="">반려문서함</a></div>
	        	</div>
	        </div>
	        ...
	        <div id="content-layout">
	        	...
	        	<div id="docu-header-area">
		        	...
		        	<div id="docu-content">
		        		...
		        		<b>내용</b>&nbsp;<textarea class="docu-content-textarea" name="" required></textarea><br><br>
		        		<b>첨부</b>&nbsp;
