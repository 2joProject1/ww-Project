		...
		<table id="noticeList" border="1">
			...
			<thead>
				<tr style="text-align:center;">
					...
					<th style="width:250px; height:35px;">카테고리</th>
			...
			<tbody>     	
				<c:forEach var="n" items="${ topList }">
					<tr> 
						...
						<td class="td_center">${ n.noticeRange }</td>
						<td class="td_center">${ n.noticeCategory }</td>
						<td>${ n.boardTitle }</td>
						<td class="td_center">${ n.enrollDate }</td>
						<td class="writer td_center">${ n.memberName }</td>
						<td class="td_center">${ n.count }</td>        
					</tr>
				</c:forEach>
