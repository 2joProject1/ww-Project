...
<body>
	...
	<div id="container">
		...
		<div class="row dt_margin dt_last">
			...
			<div class="col-10 dt_btns" style="margin-bottom:10px;">
				<c:if test="${loginUser.memberNo == detail.boardWriter}">
					<button onclick="location.href='modifyPage.co?pageNo=${detail.boardNo}'" id="cm_detail_btn">수정</button>
					<button onclick="location.href='delete.co?pageNo=${detail.boardNo}'" id="cm_detail_btn">삭제</button>
				</c:if>
		...
		<c:forEach items="${replys}" var="r">
			<form id="CommunityDeleteForm" method="post" action="deleteReply.co" style="margin-top:6px;">
			<div class="row replyDiv1">
				...
				<div class="col-1" >
					<c:if test="${loginUser.memberNo == r.memberNo}">
						<button type="submit" class="replyDeleteBtn" style="float:right">x</button>
					</c:if>
				</div>
