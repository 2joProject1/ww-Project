			...
			<div class="container">
				<div class="row">
					...
					<div class="col-3 searchView">
						<form action="list.co" method="get" accept-charset="utf-8" id="cm_searchForm">
							<input type="text" name="search" placeholder="제목, 내용으로 검색" class="searchInput"> 
							<img src="https://s3.ap-northeast-2.amazonaws.com/cdn.wecode.co.kr/icon/search.png"
								class="searchImg" onclick="$('#cm_searchForm').submit();">
						</form>
					</div>
					<div class="col-1">
						<button class="write_button" onclick="location.href='write.co'">글작성</button>
				...
				<h3 style="text-align: center; margin-bottom: 50px;"><b>이번 주 인기 게시글 Top 5</b></h3>
					<c:forEach var="top" items="${top}" varStatus="status">
						<div class="col topCol">
							<div style="text-align: center;"
								onclick="location.href='detail.co?pageNo=${top.boardNo}'">
								<img alt="top5" src="resources/coFile/${top.fileName}" width="150px;" height="150px;"
					...
					<c:forEach var="c" items="${list}" varStatus="status">
						<div class="row cm_row"
							...
							<div class="col-2">
								...
								onerror="this.src='resources/images/onerror.png'" width="100px;">
							</div>
							 
									

							<div class="col-6" style="margin-top:30px">
								<div class="cm_title" style="font-size:20px;">${c.boardTitle} <span style="color: orange; font-size:15px">[${c.replyCnt }]</span></div>
